...
def style_photo(style, image_path):
    output_path = f"stylized_images/{os.path.basename(image_path)}"
    ffwd_to_img(image_path, output_path, f"ckpt/{style}.ckpt", device=DEVICE)
    return output_path
